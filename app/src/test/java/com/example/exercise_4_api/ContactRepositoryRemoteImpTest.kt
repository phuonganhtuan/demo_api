...
class ContactRepositoryRemoteImpTest {
    ...
    private val testContactRepository = ContactRepositoryRemoteImp(contactRemoteDataSource)
    ...
    fun should_get_correct_data_from_server() {
        runBlocking {
            ...
            val contacts = testContactRepository.getAllContact()
